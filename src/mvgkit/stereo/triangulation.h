...
struct Triangulation
{
   ...
   */
  static Eigen::Array4Xf getGeometricImagePointPairCorrection(const Eigen::Array2Xf& imagePoints_L,
                                                              const Eigen::Array2Xf& imagePoints_R,
   ...
   */
  static std::pair<Eigen::Array2Xd, Eigen::Array2Xd> getOptimalPolynomialImagePointPairs(
