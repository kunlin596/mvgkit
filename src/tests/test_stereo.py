...
class TestStereo(unittest.TestCase):
    def test_fundamental_matrix_manual_correspondence(self):
        leuven_stereo_data_pack = data_model.get_leuven_stereo_data_pack()
        fundamental_rms_threshold = data_model.fundamental_rms_threshold
    ...
    def test_two_view_reprojection_error(self):
        leuven_stereo_data_pack = data_model.get_leuven_stereo_data_pack()
        stereo_reprojection_rms_threshold = data_model.stereo_reprojection_rms_threshold
    ...
    def test_affinity_recovery(self):
        book_stereo_data_pack = data_model.get_book_stereo_data_pack()
    ...
    def test_stereo_disparity(self):
        aloe_stereo_data_pack = data_model.get_aloe_stereo_data_pack()
